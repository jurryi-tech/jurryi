...
- The AI may not account for jurisdiction-specific nuances or exceptions.
- Responses are generated based on patterns in training data and may not be applicable to every situation.

**Users should always independently verify information obtained through the App with authoritative legal sources or qualified professionals.**

## 4. User Responsibilities

### 4.1 Accurate Information

You agree to provide accurate and truthful information when using the App, including during registration and when describing your legal situation. Providing false or misleading information may result in inaccurate guidance.
...
- Distribute malicious software or interfere with the App's functionality.
...
You retain ownership of the content you submit through the App (such as chat messages and queries). By submitting content, you grant us a non-exclusive, worldwide, royalty-free license to use, process, and analyze such content for the purpose of providing and improving our services.
...
- The information provided will be accurate, reliable, or complete.
...
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL LEGALSAHAY, ITS DEVELOPERS, OPERATORS, AFFILIATES, DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO:

- Loss of profits, data, use, or goodwill.
- Damages arising from reliance on information provided by the App.
- Damages resulting from any legal decisions made based on App content.
...
Our total cumulative liability to you for all claims arising out of or relating to these Terms or your use of the App shall not exceed the amount you have paid to us, if any, for use of the App during the twelve (12) months preceding the claim.
...
- Any actions taken based on information obtained through the App.

## 8. Modification and Termination

### 8.1 Changes to Terms

We reserve the right to modify these Terms at any time. We will notify you of material changes by posting the updated Terms within the App and updating the "Last Updated" date. Your continued use of the App after such modifications constitutes your acceptance of the updated Terms.
...
Any disputes arising out of or relating to these Terms or your use of the App shall be subject to the exclusive jurisdiction of the courts located in India.
